...
final fallbackKeys = <String>[
  'esc', 'escape', 'tab', 'capslock', 'space', 'enter', 'backspace',
  'leftshift', 'rightshift', 'leftcontrol', 'rightcontrol',
  'leftalt', 'rightalt', 'leftmeta', 'rightmeta', 'compose',
  'grave', 'minus', 'equal', 'leftbrace', 'rightbrace', 'backslash',
  'semicolon', 'apostrophe', 'comma', 'dot', 'slash', '102nd',
  'up', 'down', 'left', 'right',
  'home', 'end', 'pageup', 'pagedown', 'insert', 'delete',
  'sysrq', 'scrolllock', 'numlock', 'kpenter',
